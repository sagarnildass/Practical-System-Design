...
def run_simulator():
    ...
    try:
        ...
        simulator = snowflake_simulator.DistributedSystemSimulator(
            num_datacenters=2, num_machines_per_dc=3
        )
...
def main():
    ...
    sim_parser = subparsers.add_parser(
        "simulator", help="Run distributed system simulator"
    )
    ...
    verify_parser = subparsers.add_parser(
        "verify", help="Run requirements verification"
    )
