...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Distributed Key-Value Store Simulator"
    )
    ...
    parser.add_argument(
        "--replication", type=int, default=3, help="Replication factor (default: 3)"
    )
    parser.add_argument(
        "--demo",
        type=str,
    ...
    # Create simulator
    simulator = KeyValueStoreSimulator(
        num_nodes=args.nodes, replication_factor=args.replication
    )
